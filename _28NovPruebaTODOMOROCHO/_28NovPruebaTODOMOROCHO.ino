 ...
 *  @versión 3.0
 *  
 *  NOTA: 05:00 El motor de los pines 11 y 12
 *  esta chueco por lo cual hay que compensar la falta de fuerza 
 *  para eso la variable valueGiroLL
 * 
 *  NOTA: 06:19 Se optó por no usar el infrarrojo trasero
 *  ya que presenta una inclinación de unos grados considerable
 *  
 *  NOTA:
 *  
 *   * Esquema del ROBOT
 *   ________________INFRARROJOS________________
 *                      LLANTA 
 * ---------------------------
 * - beta                    -
 * -                         -
 ...
 *                      LLANTA
 *                      
 * _________________SONARES_____________________
 * 
*                        LLANTA
* -----------------------------
* -                           - 
